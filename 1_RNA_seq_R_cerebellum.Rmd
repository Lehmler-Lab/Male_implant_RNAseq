...
sum(res_low$log2FoldChange > 1 & res_low$pvalue < 0.05, na.rm=TRUE) #upregulated genes based on pvalue instead of adj. pvalue
sum(res_low$log2FoldChange < -1 & res_low$pvalue < 0.05, na.rm=TRUE) #downregulated genes based on pvalue instead of adj. pvalue
